        ...
        <div class="group-overview__list">
            ...
            <div class="group-overview__list__item clearfix">
                ...
                <div class="group-overview__list__item__icons">
                    <i class="fas fa-key group-overview__list__item__icons__get-delete" wire:click="deleteCredential({{$credential->id}})" onclick="confirm('{{ trans('Are you sure you want to remove this credential?')}}') || event.stopImmediatePropagation()"></i>
                </div>
            </div>
            @endforeach
        </div>
